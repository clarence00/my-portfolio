  ...
  return (
    <div
      ...
      <div className="h-content md:w-[50%] m-6 md:text-left text-center md:m-10 md:max-lg:w-full md:max-lg:my-4 md:max-lg:mx-0">
        <h1 className="pb-8 text-3xl font-bold md:text-3xl md:pl-2 text-customBlue-400">
          About
        </h1>
      ...
      <div className="md:w-[50%] flex md:max-lg:flex-row flex-col py-2 md:pr-2 justify-center items-center md:max-lg:w-[100%] md:max-lg:pr-0">
        <div className="p-4 m-4 mb-2 rounded-xl bg-customBlue-100 h-content w-[85%] md:max-lg:py-4">
          <a
            href="#"
          ...
          <div className="flex justify-between mt-2 italic">
            <h6 className="text-xs md:text-sm text-customBlue-300">College</h6>
            <h6 className="text-xs md:text-sm text-customBlue-300">
              2020-2024
            </h6>
          </div>
          <h6 className="text-xs md:text-sm text-customBlue-300">
        ...
        <div className="p-4 m-4 mt-2 bg-customBlue-100 h-content rounded-xl w-[85%] md:max-lg:py-6">
          <a
            href="#"
            className="font-bold text-md text-customBlue-400 md:text-lg">
            Rizal High School
          ...
          <h6 className="text-xs md:text-smm text-customBlue-300">
