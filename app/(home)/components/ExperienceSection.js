  ...
  const data = [
    {
      ...
      details: [
        ...
        "Utilized tech-stacks including React JS, Tailwind CSS, Firebase for web development and Python, NodeJS, PostgreSQL for Odoo module development. Worked with VSCode and Git for version control.",
      ],
    },
    {
